...
**Take turns as 'driver' and 'navigator', alternating roles half-way (typically a couple TODOs or one hour, whichever comes first).**
...
1. Work through one or two TODO items before switching roles (or one hour, whichever comes first), testing your code as you go.
...
3. Once they have accepted the invite to collaborate, `Slack` the link to your forked repo to your partner so they can clone it.
